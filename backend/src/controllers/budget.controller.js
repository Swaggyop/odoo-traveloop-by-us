...
const getTripBudget = async (req, res) => {
  ...
  try {
    ...
    res.json({
      ...
      total_expenses: parseFloat(grandTotal.toFixed(2)),
      transport_total: parseFloat(totals.transport.toFixed(2)),
      accommodation_total: parseFloat(totals.accommodation.toFixed(2)),
      activities_total: parseFloat(totals.activities.toFixed(2)),
